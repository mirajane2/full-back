...
class PirateController extends AbstractController {
    ...
    #[Route('/api/pirate/{id}', methods:['PUT'])]
    ...
    #[Route('/api/equipage/{id}/pirate/${id}', methods:['GET'])]
    public function pirate (PirateRepository $pirateR, int $id, Request $request, EntityManagerInterface $em) {
        ...
        return $this->json(['message' => 'Pirate mis à jour avec succès']);
