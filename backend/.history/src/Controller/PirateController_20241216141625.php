...
class PirateController extends AbstractController {
    ...
    #[Route('/api/equipage/{crewId/pirate/{id}', methods:['PUT'])]
    public function update(Request $request, EntityManagerInterface $em, int $id, int $crewId, PirateRepository $repository): JsonResponse {
